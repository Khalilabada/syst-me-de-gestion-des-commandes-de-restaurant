...
public class MenuClientPanel extends JPanel {
    ...
    private int getCurrentClientId() {
        // You'll need to get this from your parent frame or pass it to the panel
        Window parent = SwingUtilities.getWindowAncestor(this);
        if (parent instanceof ClientDashboard) {
            return ((ClientDashboard) parent).clientId;
        }
        return -1; // or throw an exception if client ID is required
    }
